  ...
  const appGridItems = [
    {
      ...
      icon: Zap,
      badge: companyWeighings.length > 0 ? `${companyWeighings.length} Pesajes` : 'Venta',
    ...
    },
    {
      ...
      icon: Coins,
      badge: pendingWeighings.length > 0 ? `S/ ${totalPendingSoles.toFixed(0)} Pendiente` : 'Cuentas por Cobrar',
